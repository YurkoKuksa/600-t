      ...
      <ul>
        ...
        <ListWrapper>
          ...
          <Paragraph>
            ...
            хімічну реакцію, що вивільняє CO2, який загасає пожежу шляхом
            виведення кисню та поглинання тепла.
          </Paragraph>
        </ListWrapper>
        <ListWrapper>
          <Title>
        ...
        <ListWrapper>
          ...
          <Paragraph>
        Багато відбілюючих засобів містять хімічні речовини, такі як пероксид водню або перкарбамід. Ці речовини взаємодіють з плямами і роблять їх менш помітними.
          </Paragraph>
        </ListWrapper>
      </ul>
    </MainBox>
